...
class CriticNetwork(nn.Module):
    ...
    def forward(self, state, action):
        ...
        # return self.state_action_value_layers.forward(T.add(state_value, action_value))
...
def init_linear_layer(input_dims, output_dims, weight_bias_range=None):
    ...
    T.nn.init.uniform_(layer.weight.data, -weight_bias_range, weight_bias_range)
    T.nn.init.uniform_(layer.bias.data, -weight_bias_range, weight_bias_range)
